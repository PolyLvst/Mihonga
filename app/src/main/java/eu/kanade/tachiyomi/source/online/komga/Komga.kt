package eu.kanade.tachiyomi.source.online.komga
...
import eu.kanade.tachiyomi.source.online.komga.dto.AuthorDto
import eu.kanade.tachiyomi.source.online.komga.dto.BookDto
import eu.kanade.tachiyomi.source.online.komga.dto.CollectionDto
import eu.kanade.tachiyomi.source.online.komga.dto.LibraryDto
import eu.kanade.tachiyomi.source.online.komga.dto.PageDto
import eu.kanade.tachiyomi.source.online.komga.dto.PageWrapperDto
import eu.kanade.tachiyomi.source.online.komga.dto.ReadListDto
import eu.kanade.tachiyomi.source.online.komga.dto.SeriesDto
...
open class Komga(private val suffix: String = "") : ConfigurableSource, UnmeteredSource, HttpSource() {
    ...
    override fun chapterPageParse(response: Response): SChapter {
        throw UnsupportedOperationException("Komga does not support chapter page parsing.")
    }
